...
const MockupApp = {
  ...
  SCENARIOS: [
    ...
    /* ═══════════════ 場景一：接單評估 ═══════════════ */
    {
      ...
      summaryNote: '自動完成任務，在生成客戶訂單的同時，同步通知相關部門。',
      steps: [
        {
          id: 1, node: '辨識採購圖檔',
          ...
          systems: [
            { name: '文件識別', api: 'Document AI OCR', icon: '📄', bg: '#F0F0FF' },
            { name: 'ERP系統', api: 'ERP System', icon: '🔤', bg: '#FFF0FF' },
          ],
          bubbleText: `辨識助理處理中…\n\n✅ 採購圖檔解析完成（格式：PDF）\n\n• 客戶名稱：一級棒公司\n• 客戶代號：1080\n• 採購品號：Z_P\n• 採購數量：998 件\n• 訂單金額：NT$ 1,400 元`,
        ...
        },
        {
          ...
          systems: [
            { name: '查詢公司規章', api: 'Policy Engine', icon: '📜', bg: '#FFF5F5' },
            { name: '知識庫系統', api: 'Knowledge Base', icon: '⚙️', bg: '#FFF0E8' },
          ],
        ...
        },
        {
          ...
          systems: [
            { name: '生產排程系統', api: 'Production API', icon: '🏭', bg: '#FFFBEB' },
            { name: '查詢庫存', api: 'Inventory API', icon: '🛒', bg: '#FFF7F0' },
          ],
        ...
        {
          id: 5, node: '推估交期利潤',
          agentName: '生產排程助理', agentIcon: '📊',
          agentColor: '#059669', agentBg: '#D1FAE5',
          systems: [
            { name: '生產排程系統', api: 'Production API', icon: '🏗️', bg: '#ECFDF5' },
            { name: '查詢歷史成本', api: 'Finance API', icon: '💹', bg: '#F0FFF4' },
          ],
          bubbleText: `生產排程助理執行中…\n\n💰 利潤分析：\n• 銷貨單價：NT$ 1,400\n• 銷貨成本：NT$ 800\n• 預估毛利：NT$ 600\n• 毛利率：42.86%\n\n📅 交期推估：\n• 預計生產完成：2026/10/09\n• 預計出貨交期：2026/10/16\n\n✅ 生產週期符合客戶要求`,
        ...
        },
        {
          ...
          agentColor: '#0066CC', agentBg: '#E8F0FF',
          systems: [
            { name: 'ERP 系統', api: 'ERP System', icon: '📝', bg: '#EFF6FF' },
            { name: '通知軟體', api: 'Notify API', icon: '🔔', bg: '#FFFBEB' },
            { name: '訂單生成通知', api: 'ERP System', icon: '🏢', bg: '#F0F9FF' },
          ],
